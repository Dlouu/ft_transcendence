...
📤 Returns:
- Redirect to /join_lobby?code=...
- Error message if the room does not exist

🎯 Purpose:
Allows a user to join a lobby using a room code.
"""
